...
#ifndef SVENTT_TRANSPOSITION_SVE_GATHER_IMMEDIATE_INDEX_ROW_FIRST_HPP_INCLUDED
#define SVENTT_TRANSPOSITION_SVE_GATHER_IMMEDIATE_INDEX_ROW_FIRST_HPP_INCLUDED
...
class TransposeSVEGatherRowFirst {
...
template <std::uint64_t block_rows, std::uint64_t block_cols>
class TransposeParallelSVEGatherRowFirst {
...
#endif /* SVENTT_TRANSPOSITION_SVE_GATHER_IMMEDIATE_INDEX_ROW_FIRST_HPP_INCLUDED \
        */
